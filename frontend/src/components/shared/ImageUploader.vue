...
<template>
  <div class="w-full">
    <div class="flex flex-col items-center">
      ...
      <div v-if="!imagePreview" class="flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed border-gray-300 rounded-full bg-gray-50 hover:bg-gray-100 cursor-pointer" @click="triggerFileInput">
