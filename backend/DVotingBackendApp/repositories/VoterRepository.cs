    ...
    public class VoterRepository : IVoterRepository
    {
        ...
        public async Task<string> RegisterVoterAsync(Voter voter)
        {
            ...
            var tx = await function.SendTransactionAndWaitForReceiptAsync(
                ...
                voter.Location, voter.Phone, voter.IrisSamples);
        ...
        public async Task<List<string>> FetchIrisSampleAsync(string uid)
        {
            var function = _contract.GetFunction("getIrisSample");

            var result = await function.CallAsync<List<string>>(uid);
