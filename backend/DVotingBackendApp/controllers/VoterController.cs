...
namespace DVotingBackendApp.controllers
{
    ...
    public class VoterController : Controller
    {
        ...
        [HttpGet("{constituency}/irisSamples")]
        public async Task<IActionResult> FetchIrisSamples(string constituency)
        {
            {
                try
                {
                    var sample = await _voterService.FetchIrisSampleAsync(constituency);
